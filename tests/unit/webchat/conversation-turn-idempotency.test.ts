...
function service(aiStore: MemoryAiStore, interpret: NaturalLanguageIntentClient["interpret"]) {
  return new ConversationTurnService(
    ...
    sessionSecret, 3_600, () => now, aiStore,
    {
      ...
      maxOutputTokens: 300, maxCallsPerConversation: 5, dailyBudgetUsd: 0.5, monthlyBudgetUsd: 5,
