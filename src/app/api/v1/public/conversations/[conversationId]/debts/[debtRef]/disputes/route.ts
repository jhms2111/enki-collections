...
import { disputeSchema } from "@/modules/conversations/occurrence.schemas";
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    const result = await getOccurrenceService().openDispute({
      ...
      request: disputeSchema.parse(await request.json()),
